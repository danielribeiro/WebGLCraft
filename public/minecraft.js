...
(function() {
  ...
  Grid = (function() {
    function Grid(_at_size) {
      this.size = _at_size != null ? _at_size : 5;
      this.matrix = [];
      this.size.times((function(_this) {
        return function(i) {
          _this.matrix[i] = [];
  ...
  CollisionHelper = (function() {
    function CollisionHelper(_at_player, _at_grid) {
      this.player = _at_player;
      this.grid = _at_grid;
      return;
    }
  ...
  Game = (function() {
    function Game(_at_populateWorldFunction) {
      this.populateWorldFunction = _at_populateWorldFunction;
    ...
    Game.prototype.populateWorld2 = function() {
      ...
      middle = this.grid.size / 2;
      ret = this.populateWorldFunction != null ? (setblockFunc = (function(_this) {
        return function(x, y, z, blockName) {
          return _this.cubeAt(x, y, z, _this.cubeBlocks[blockName]);
        };
      })(this), this.populateWorldFunction(setblockFunc, middle)) : [middle, 3, middle];
      pos = (function() {
        var _i, _len, _results;
        _results = [];
    ...
    Game.prototype.defineControls = function() {
      ...
      $(document).bind('keydown', 'p', (function(_this) {
        return function() {
          return _this.togglePause();
        };
      })(this));
      $(document).bind('keydown', 'k', (function(_this) {
        return function() {
          return _this.save();
        };
      })(this));
      ...
      for (_j = 0, _len1 = _ref1.length; _j < _len1; _j++) {
        target = _ref1[_j];
        $(target).mousedown((function(_this) {
          return function(e) {
            return _this.onMouseDown(e);
          };
        })(this));
        $(target).mouseup((function(_this) {
          return function(e) {
            return _this.onMouseUp(e);
          };
        })(this));
        _results.push($(target).mousemove((function(_this) {
          return function(e) {
    ...
    Game.prototype.createCubeAt = function(x, y, z) {
      return this.cubeAt(x, y, z, this.currentCube, (function(_this) {
