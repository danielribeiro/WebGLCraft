  ...
  describe("Intersection utils", function() {
    it("can decide interval collision", function() {
      ...
      collides = function() {
        ...
        return CollisionUtils.testIntervalCollision.apply(CollisionUtils, args);
      };
    ...
    it("can decide when unrotated cubes don't collide ", function() {
      ...
      return isFalse(CollisionUtils.testCubeCollision(cube1, cube2));
    });
    return it("can decide when unrotated cubes do collide ", function() {
      ...
      return isTrue(CollisionUtils.testCubeCollision(cube1, cube2));
    });
  });

}).call(this);

//# sourceMappingURL=applicationSpec.js.map
